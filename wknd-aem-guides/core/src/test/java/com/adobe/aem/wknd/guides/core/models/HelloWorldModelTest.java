 ...
 */
package com.adobe.aem.wknd.guides.core.models;
...
import com.adobe.aem.wknd.guides.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "wknd site/components/helloworld");
